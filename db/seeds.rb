...
u2 = User.new(name: 'mario', email: 'mario@mail.it', password: "pw")
u3 = User.new(name: 'bob', email: 'bob@mail.it', password: "pw")
u4 = User.new(name: 'em', email: 'em@mail.it', password: "pw")
u5 = User.new(name: 'jemelle', email: 'jemelle@mail.it', password: "pw")
u6 = User.new(name: 'toks', email: 'toks@mail.it', password: "pw")
u7 = User.new(name: 'mara', email: 'mara@mail.it', password: "pw")
u8 = User.new(name: 'ale', email: 'ale@mail.it', password: "pw")
u9 = User.new(name: 'ilam', email: 'ilam@mail.it', password: "pw")
